...
pranges="--xscale-range-list 0.01,2 --xshift-range-list=-0.5,3 --yscale-range-list 5,25 --time-to-sampling-range-list 17,25 --n-seqs-range-list 65,95"
...
echo $bin $common --label retrain --version v0 --carry-cap-range-list 750,1500 $pranges --n-replicates 1 --n-trials-list 100:5000 --simu-bundle-size-list 1:50:67 --dl-bundle-size-list 1:50:67 --zip-vars simu-bundle-size:dl-bundle-size --simu-extra-args=\"--n-max-procs 20 --initial-birth-rate-range 0.1 0.5\"

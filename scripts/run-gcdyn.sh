...
echo $bin --actions simu --label x-ceil --version v0 --carry-cap-range-list 500,2000 --init-population-values-list 8,16,32,64,128,256 --x-ceil-start-range-list 0.5,2.5 --n-trials-list 100 $sxtra $dlargs $common
# exit 0

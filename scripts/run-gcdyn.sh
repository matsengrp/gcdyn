...
dmargs="--xscale-values-list 1.1 --xshift-values-list 1.3 --yshift-values-list 0.5 --simu-extra-args=\"--carry-cap-values 500 --init-population-values 128 --death-values 0.5 --mutability-multiplier 0.5 --time-to-sampling-values 20 --n-seqs-range 60 95 --n-trials 120\" --n-sub-procs 30"
# 500 128 0.4: 1.1 1.3 13.4 0.5
...
dlabel=data-iqtree-trained-iqtree-data; dvsn=v9
...
#  gcd-dl infer --is-simu --indir /fh/fast/matsen_e/dralph/partis/gcdyn/data-iqtree-trained-iqtree-data/v9/data-samples-combo-trees/model-type-sigmoid/carry-cap-values-500/init-population-values-128/death-values-0.4/check-dl/iqtree --outdir /fh/fast/matsen_e/dralph/partis/gcdyn/data-iqtree-trained-iqtree-data/v9/data-samples-combo-trees/model-type-per-bin/carry-cap-values-500/init-population-values-128/death-values-0.4/dl-infer/iqtree --model-dir /fh/fast/matsen_e/dralph/partis/gcdyn/for-data/v6/n-trials-50000/model-type-per-bin/dl-infer/iqtree --model-type per-bin

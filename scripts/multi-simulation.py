...
parser.add_argument('--xscale-list', default=2, type=float, nargs='+', help='parameters (see also {x,y}{scale,shift}) for birth (consant, sigmoid and soft-relu) response. If more than one is specified, one is chosen at random for each tree.')

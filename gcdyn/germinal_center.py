...
class GerminalCenter:
    ...
    def __init__(self, starting_population: list):
        ...
        # XXX Passing the RNG to the sampler.
    ...
    def add_cell(self, cell):
        """
        Add the cell to the GC, namely to the population and the sampler.
        """
    ...
    def make_and_add_child_cell(self, parent):
        ...
        child.detach()
        # We have duplicated the parent, but we don't want to keep its descendants.

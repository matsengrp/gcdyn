...
class Fitness:
    ...
    def frac_antigen_bound(self, sequence_KDs: list[float]) -> list[float]:
        ...
        Args:
            sequence_KDs: a list of KDs that will each be used to determine the fraction of antigen bound.

        Returns:
            List of values representing the fraction of receptors with antigen bound
        """
        thetas = []
    ...
    def sigmoidal_fitness(
        ...
        Args:
            ...
            curve_steepness: parameter to control t cell help
            midpoint_antigen_bound: value of input antigen bound to
    ...
    def map_cell_divisions(self, seq_df: pd.DataFrame, slope: float = 1) -> list[float]:
        """Map T cell help linearly to the number of cell divisions using
        slope."""
        seq_df["cell_divisions"] = seq_df["normalized_t_cell_help"] * slope
